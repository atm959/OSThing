...
void idt_init(){
    extern int load_idt(long unsigned int* idtPtr);
    extern int zeroDivide();
    extern int irq0();
    extern int irq1();
    extern int irq2();
    extern int irq3();
    ...
    unsigned long zeroDivide_address;
    ...
    zeroDivide_address = (unsigned long)zeroDivide;
    IDT[0].offset_lowerbits = zeroDivide_address & 0xFFFF;
    IDT[0].selector = 0x08;
    IDT[0].zero = 0;
    IDT[0].type_attr = 0x8E;
    IDT[0].offset_higherbits = (zeroDivide_address & 0xFFFF0000) >> 16;
